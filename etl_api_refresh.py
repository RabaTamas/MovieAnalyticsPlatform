    ...
    for attempt in range(max_retries):
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"   ⚠️  Rate limit hit, waiting {RETRY_DELAY * (attempt + 1)}s...")
...
# =============================================================================
print("\n" + "=" * 80)
print("🎞️  Step 2: Fetching detailed info for each movie")
print("=" * 80)
...
for movie in detailed_movies:
    try:
        ...
        print(f"   ⚠️  Error parsing movie {movie.get('id')}: {e}")
        continue
